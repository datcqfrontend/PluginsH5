$.fn.srt = function(options){
    var instance = null;
    this.each(function(){
        if (null == $(this).data('srt')) {
            instance = new srt($(this),options);
            $(this).data('srt', instance);
        }
        else {
            instance = $(this).data('srt');
        }
    });
    return instance;
};
...
var srt = function(video, options){
    this.initalize(video, options);
}
$.extend(srt.prototype, {
    initalize: function(video, options){
