    ...
    $.Controller.extend("Drcom.Popup", {
        ...
        closeAllPopup: function(ignore) {
            ...
            for (var i = 0; i < popups.length; i++) {
                ...
                if (exist == true)
                    continue;
                var popup = $(popups[i]).controller(Drcom.Popup);
        ...
        onAfterShow: function()
        {
            ...
            if($(this.options.childShow).length>0)
                $(this.options.childShow,'.popup').show(this.options.effect, null, this.options.duration);
        },
        show: function() {
            function showPopup() {
                ...
                var instance = this;
                this.container.show(this.options.effect, null, 100, function() {
